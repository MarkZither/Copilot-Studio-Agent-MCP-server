# Coding Guidelines — CopilotStudioAgentOptions-mcp-server
...
- Test project: `tests/CopilotStudioAgent.Mcp.Server.Tests/` using **xUnit**, **Moq**, and **FluentAssertions**.
...
- Folders mirror namespaces: `CopilotStudioAgent.Mcp.Server.Tools`, `CopilotStudioAgent.Mcp.Server.Api`, etc.
